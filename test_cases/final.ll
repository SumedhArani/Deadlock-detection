...
terminate.lpad.i:                                 ; preds = %entry
  ...
  tail call void @__clang_call_terminate(i8* %2) #8
  unreachable
...
entry:
  ...
  call void @llvm.lifetime.start(i64 16, i8* %0) #9
...
lpad.i.i:                                         ; preds = %invoke.cont.i.i, %.noexc
  ...
  call void @_ZNSt3__16localeD1Ev(%"class.std::__1::locale"* nonnull %ref.tmp.i.i) #9
  br label %lpad1.body
...
lpad1.body:                                       ; preds = %lpad.i.i, %lpad1
  ...
  call void @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEE6sentryD1Ev(%"class.std::__1::basic_ostream<char, std::__1::char_traits<char> >::sentry"* nonnull %__s) #9
  ...
  %26 = call i8* @__cxa_begin_catch(i8* %exn.slot.0) #9
...
if.then17:                                        ; preds = %if.end15
  ...
  call void @llvm.lifetime.start(i64 24, i8* %3) #9
  call void @llvm.memset.p0i8.i64(i8* %3, i8 0, i64 24, i32 8, i1 false) #9
...
invoke.cont:                                      ; preds = %if.then17
  ...
  call void @_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEED1Ev(%"class.std::__1::basic_string"* nonnull %__sp) #9
  call void @llvm.lifetime.end(i64 24, i8* %3) #9
...
for.body:                                         ; preds = %entry, %invoke.cont
  ...
  call void @llvm.memset.p0i8.i64(i8* %0, i8 0, i64 24, i32 8, i1 false) #9
...
invoke.cont:                                      ; preds = %.noexc
  call void @_Z3Etav()
  call void @_ZNSt3__15mutex6unlockEv(%"class.std::__1::mutex"* %mu2.i) #9
  call void @_Z3Etav()
  call void @_ZNSt3__15mutex6unlockEv(%"class.std::__1::mutex"* %mu1.i) #9
  call void @_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEED1Ev(%"class.std::__1::basic_string"* nonnull %agg.tmp) #9
...
invoke.cont:                                      ; preds = %entry
  ...
  call void @llvm.lifetime.start(i64 8, i8* %4) #9
...
invoke.cont8:                                     ; preds = %invoke.cont7
  call void @_ZNSt3__16threadD1Ev(%"class.std::__1::thread"* nonnull %t2) #9
  call void @llvm.lifetime.end(i64 8, i8* %4) #9
  call void @_ZNSt3__16threadD1Ev(%"class.std::__1::thread"* nonnull %t1) #9
  call void @llvm.lifetime.end(i64 8, i8* %3) #9
  %mu2.i.i13 = getelementptr inbounds %class.LogFile, %class.LogFile* %log, i64 0, i32 1
  call void @_ZNSt3__15mutexD1Ev(%"class.std::__1::mutex"* %mu2.i.i13) #9
  %mu1.i.i14 = getelementptr inbounds %class.LogFile, %class.LogFile* %log, i64 0, i32 0
  call void @_ZNSt3__15mutexD1Ev(%"class.std::__1::mutex"* %mu1.i.i14) #9
  call void @llvm.lifetime.end(i64 128, i8* %0) #9
  ret i32 0
...
ehcleanup10:                                      ; preds = %ehcleanup, %lpad
  ...
  call void @_ZNSt3__15mutexD1Ev(%"class.std::__1::mutex"* %mu2.i.i) #9
  %mu1.i.i = getelementptr inbounds %class.LogFile, %class.LogFile* %log, i64 0, i32 0
  call void @_ZNSt3__15mutexD1Ev(%"class.std::__1::mutex"* %mu1.i.i) #9
  call void @llvm.lifetime.end(i64 128, i8* %0) #9
...
invoke.cont:                                      ; preds = %entry
  %call4 = invoke i8* @_Znwm(i64 24) #10
...
invoke.cont3:                                     ; preds = %invoke.cont
  ...
  store i64 %2, i64* %6, align 8, !tbaa !28
...
lpad:                                             ; preds = %entry
  ...
  tail call void @_ZdlPv(i8* nonnull %call) #11
  br label %eh.resume
...
delete.notnull.i.i.i.i38:                         ; preds = %if.else
  ...
  %14 = load %"class.std::__1::__thread_struct"*, %"class.std::__1::__thread_struct"** %__first_.i.i.i.i.i.i.i.i.i.i.i.i.i.i36, align 8, !tbaa !30
  store %"class.std::__1::__thread_struct"* null, %"class.std::__1::__thread_struct"** %__first_.i.i.i.i.i.i.i.i.i.i.i.i.i.i36, align 8, !tbaa !30
...
_ZNKSt3__114default_deleteINS_15__thread_structEEclEPS1_.exit.i.i.i.i.i.i.i.i.i.i.i.i39: ; preds = %delete.notnull.i.i.i.i38
  tail call void @_ZNSt3__115__thread_structD1Ev(%"class.std::__1::__thread_struct"* nonnull %14) #9
...
_ZNKSt3__114default_deleteINS_5tupleIJNS_10unique_ptrINS_15__thread_structENS0_IS3_EEEEPFvR7LogFileENS_17reference_wrapperIS6_EEEEEEclEPSC_.exit.i.i.i40: ; preds = %_ZNKSt3__114default_deleteINS_15__thread_structEEclEPS1_.exit.i.i.i.i.i.i.i.i.i.i.i.i39, %delete.notnull.i.i.i.i38
  tail call void @_ZdlPv(i8* %call4) #11
...
ehcleanup:                                        ; preds = %lpad19, %lpad15
  ...
  %18 = load %"class.std::__1::__thread_struct"*, %"class.std::__1::__thread_struct"** %__first_.i.i.i.i.i.i.i.i.i.i.i.i.i.i, align 8, !tbaa !30
  store %"class.std::__1::__thread_struct"* null, %"class.std::__1::__thread_struct"** %__first_.i.i.i.i.i.i.i.i.i.i.i.i.i.i, align 8, !tbaa !30
...
_ZNKSt3__114default_deleteINS_15__thread_structEEclEPS1_.exit.i.i.i.i.i.i.i.i.i.i.i.i: ; preds = %ehcleanup
  tail call void @_ZNSt3__115__thread_structD1Ev(%"class.std::__1::__thread_struct"* nonnull %18) #9
...
ehcleanup22.thread:                               ; preds = %ehcleanup, %_ZNKSt3__114default_deleteINS_15__thread_structEEclEPS1_.exit.i.i.i.i.i.i.i.i.i.i.i.i
  tail call void @_ZdlPv(i8* nonnull %call4) #11
  br label %eh.resume
...
ehcleanup22:                                      ; preds = %invoke.cont
  ...
  tail call void @_ZNSt3__115__thread_structD1Ev(%"class.std::__1::__thread_struct"* nonnull %0) #9
  tail call void @_ZdlPv(i8* nonnull %call) #11
  br label %eh.resume
...
invoke.cont:                                      ; preds = %entry
  ...
  store %"class.std::__1::__thread_struct"* null, %"class.std::__1::__thread_struct"** %__first_.i.i.i10, align 8, !tbaa !30
  %__key_.i.i = getelementptr inbounds %"struct.std::__1::once_flag", %"struct.std::__1::once_flag"* %call, i64 0, i32 0
  %2 = load i64, i64* %__key_.i.i, align 8, !tbaa !31
...
call.i.i.i.noexc:                                 ; preds = %invoke.cont
  %3 = load i64, i64* %__key_.i.i, align 8, !tbaa !31
...
delete.notnull.i:                                 ; preds = %call.i.i.noexc
  ...
  tail call void @_ZNSt3__115__thread_structD1Ev(%"class.std::__1::__thread_struct"* nonnull %4) #9
  tail call void @_ZdlPv(i8* nonnull %call.i.i.i19) #11
...
invoke.cont5:                                     ; preds = %delete.notnull.i, %call.i.i.noexc
  ...
  %6 = load void (%class.LogFile*)*, void (%class.LogFile*)** %5, align 8, !tbaa !30
  %__f_.i.i.i = getelementptr inbounds i8, i8* %__vp, i64 16
  %7 = bitcast i8* %__f_.i.i.i to %class.LogFile**
  %8 = load %class.LogFile*, %class.LogFile** %7, align 8, !tbaa !33
...
delete.notnull.i.i.i.i15:                         ; preds = %invoke.cont5
  %9 = load %"class.std::__1::__thread_struct"*, %"class.std::__1::__thread_struct"** %__first_.i.i.i10, align 8, !tbaa !30
  store %"class.std::__1::__thread_struct"* null, %"class.std::__1::__thread_struct"** %__first_.i.i.i10, align 8, !tbaa !30
...
_ZNKSt3__114default_deleteINS_15__thread_structEEclEPS1_.exit.i.i.i.i.i.i.i.i.i.i.i.i16: ; preds = %delete.notnull.i.i.i.i15
  tail call void @_ZNSt3__115__thread_structD1Ev(%"class.std::__1::__thread_struct"* nonnull %9) #9
...
_ZNSt3__110unique_ptrINS_5tupleIJNS0_INS_15__thread_structENS_14default_deleteIS2_EEEEPFvR7LogFileENS_17reference_wrapperIS6_EEEEENS3_ISC_EEED1Ev.exit18: ; preds = %delete.notnull.i.i.i.i15, %_ZNKSt3__114default_deleteINS_15__thread_structEEclEPS1_.exit.i.i.i.i.i.i.i.i.i.i.i.i16
  tail call void @_ZdlPv(i8* nonnull %__vp) #11
  ret i8* null
...
delete.notnull.i.i.i.i:                           ; preds = %lpad.thread, %lpad
  ...
  %11 = load %"class.std::__1::__thread_struct"*, %"class.std::__1::__thread_struct"** %__first_.i.i.i.i.i.i.i.i.i.i.i.i.i.i, align 8, !tbaa !30
  store %"class.std::__1::__thread_struct"* null, %"class.std::__1::__thread_struct"** %__first_.i.i.i.i.i.i.i.i.i.i.i.i.i.i, align 8, !tbaa !30
...
_ZNKSt3__114default_deleteINS_15__thread_structEEclEPS1_.exit.i.i.i.i.i.i.i.i.i.i.i.i: ; preds = %delete.notnull.i.i.i.i
  tail call void @_ZNSt3__115__thread_structD1Ev(%"class.std::__1::__thread_struct"* nonnull %11) #9
...
!24 = !{!25, !14, i64 0}
!25 = !{!"_ZTS23_opaque_pthread_mutex_t", !14, i64 0, !4, i64 8}
!26 = !{!27, !15, i64 0}
!27 = !{!"_ZTSNSt3__128__libcpp_compressed_pair_impIPNS_15__thread_structENS_14default_deleteIS1_EELj2EEE", !15, i64 0}
!28 = !{!29, !15, i64 0}
!29 = !{!"_ZTSNSt3__112__tuple_leafILm1EPFvR7LogFileELb0EEE", !15, i64 0}
!30 = !{!15, !15, i64 0}
!31 = !{!32, !14, i64 0}
!32 = !{!"_ZTSNSt3__121__thread_specific_ptrINS_15__thread_structEEE", !14, i64 0}
!33 = !{!34, !15, i64 0}
!34 = !{!"_ZTSNSt3__117reference_wrapperI7LogFileEE", !15, i64 0}
